...
class SC_Prompt_Builder {

    /**
     * Main prompt — previous content-এর উপর ভিত্তি করে build করে
     */
    public function build(
        ...
        string $exam_name,
        string $existing_content = '' // আগের generate করা content
    ): string {

        $wrong_options = $this->get_wrong_options( $options, $correct_answer );
...
PROMPT;
    ...
    private function get_wrong_options( array $options, string $correct_answer ): array {
        return array_filter(
            $options,
